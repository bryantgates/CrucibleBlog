...
namespace CrucibleBlog.Controllers
{
    ...
    public class BlogPostsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Abstract,Content,CreatedDate,UpdatedDate,Slug,IsPublished,CategoryId,ImageData,ImageType")] BlogPost blogPost)
        {
